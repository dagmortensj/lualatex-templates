...
\usepackage[e]{esvect}
% esvect's font definition lists exact sizes only (5, 6, ..., 10 pt),
% while unicode-math asks for fractional maths sizes -- NewCM's
% scriptscript is 0.50 x 10.95 = 5.475 pt -- and LaTeX substitutes
% silently only within 0.4 pt. Continuous ranges cover every size.
% This is the same fix the overarrows author adopted upstream.
