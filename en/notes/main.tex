...
\usepackage{siunitx}
% Configuration (per-mode, uncertainty) lives in the style file.
...
% BIBLIOGRAPHY
%
% The bibliography is set with \printbibliography at the
% end of the document; the style (biblatex, numeric, in
% citation order) lives in notesstyle.sty.
% ============================================================
