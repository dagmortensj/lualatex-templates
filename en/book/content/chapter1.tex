...
% whole book when a figure changes.  bookstyle.sty defines no figure
% palette; if you want the collection's colors from the notes and
% handout styles, define them in the standalone preamble with xcolor:
