...
% =================================================
\usepackage{amsmath}       % no amssymb: unicode-math supplies the
                           % symbols, and loading both breaks the
                           % build (\eth already defined)
                           % mathtools is NOT loaded: see the README
                           % for the unicode-math-native alternatives
                           % no bm: incompatible with unicode-math.
                           % Bold maths is \symbf / \symbfit / \symbfup.
