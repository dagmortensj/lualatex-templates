...
\usepackage{amsmath}                % ikke amssymb: unicode-math
                                    % leverer symbolene
% mathtools lastes IKKE -- se README for alternativene
% som er native i unicode-math

% --- Vektorer: \vv{F}, flat pil som spenner over hele symbolet ---
\usepackage[e]{esvect}
% esvect sin fontdefinisjon lister bare eksakte størrelser
% (5, 6, ..., 10 pt), mens unicode-math ber om brøkne mattestørrelser
% -- NewCM sin scriptscript er 0,50 x 10,95 = 5,475 pt -- og LaTeX
% bytter bare stille innenfor 0,4 pt. Sammenhengende intervaller
% dekker alle størrelser. Dette er samme fiks som forfatteren av
% overarrows tok inn upstream.
...
\usepackage{siunitx}
\sisetup{output-decimal-marker={,},   % norsk desimalkomma
         range-phrase={ til },        % \qtyrange: "10 km til 20 km"
         list-final-separator={ og }, % \qtylist: "1 V, 2 V og 3 V"
         list-pair-separator={ og },
         per-mode=symbol,             % m/s^2, ikke m s^-2
         separate-uncertainty=true}   % (25,3 +- 0,4) grader C

% --- Tensorindekser: \tensor{R}{^\rho_\sigma_\mu_\nu} ---
\usepackage{tensor}
...
% skrevet for pdflatex-tida. Den virker riktignok sammen med siunitx om
% du legger til \AtBeginDocument{\RenewCommandCopy\qty\SI}, mot én
% siunitx-advarsel -- men physics2 dekker det samme uten.

% --- Valgfritt ---
% \usepackage{slashed}              % Feynman-skråstrek
% Ikke bm under unicode-math: fet matte er \symbf.
...
% Oppreist d og i: \symup er unicode-math-formen (\mathrm virker også).
